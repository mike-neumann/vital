...
const whyFeatures = computed<PageCardProps[]>(() => [
  {
...
const plannedFeatures = computed<PageFeatureProps[]>(() => [
  {
...
<template>
  <div>
    ...
    <UPageSection>
      <UPageCTA
        :title="t('view.index.cta.title')"
        :description="t('view.index.cta.description')"
        variant="subtle"
        orientation="horizontal"
      >
        <UPageGrid>
          <UPageCard
            :title="t('view.index.cta.cards.documentation.title')"
