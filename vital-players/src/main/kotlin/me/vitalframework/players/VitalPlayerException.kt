...
abstract class VitalPlayerException(message: String, cause: Throwable? = null) : RuntimeException(message, cause) {
    class InvalidClass(playerClass: Class<*>, cause: Throwable) :
        VitalPlayerException("invalid class '${playerClass.simpleName}' does not extend '${VitalPlayer::class.java.simpleName}'", cause)
