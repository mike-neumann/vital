...
object VitalClassUtils {
    /**
     * Gets the specified annotation as a required attribute on the call-site type.
     * @throws RuntimeException If the annotation is not present during call.
     */
    ...
    /**
     * Gets all annotations of the specified type as required attributes on the call-site type.
     * @throws RuntimeException If no annotations were found during call.
     */
