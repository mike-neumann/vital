...
abstract class VitalCommandException(message: String, cause: Throwable? = null) : RuntimeException(message) {
    ...
    class UnmappedArgHandler(arg: String) : VitalCommandException(
        "No handler method exists for arg '$arg'"
    )
    ...
    class UnmappedArgExceptionHandlerArg(arg: String) : VitalCommandException(
        "Exception handler mapping failed, arg '$arg' does not exist"
    )
