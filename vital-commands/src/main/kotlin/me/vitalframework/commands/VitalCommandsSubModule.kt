 ...
 */
fun VitalCommand.ArgHandlerContext.getInjectableArgHandlerMethodParameters(
    sender: Any,
    executedArg: String,
 ...
 */
fun VitalCommand.ArgExceptionHandlerContext.getInjectableArgExceptionHandlerMethodParameters(
    sender: Any,
    executedArg: String,
    commandArg: VitalCommand.Arg,
    exception: Throwable,
 ...
 */
fun Method.getArgHandlerContext(commandSenderClass: Class<*>): VitalCommand.ArgHandlerContext {
    if (returnType != VitalCommand.ReturnState::class.java) {
    ...
    for (parameter in parameters) {
        when {
            commandSenderClass.isAssignableFrom(parameter.type) -> commandSenderIndex = parameters.indexOf(parameter)
            String::class.java.isAssignableFrom(parameter.type) -> executedArgIndex = parameters.indexOf(parameter)
            VitalCommand.Arg::class.java.isAssignableFrom(parameter.type) -> commandArgIndex = parameters.indexOf(parameter)
            Array<String>::class.java.isAssignableFrom(parameter.type) -> valuesIndex = parameters.indexOf(parameter)
            else -> throw VitalCommandException.InvalidArgHandlerParameterSignature(this, parameter)
        }
    }

    return VitalCommand.ArgHandlerContext(this, commandSenderIndex, executedArgIndex, commandArgIndex, valuesIndex)
}
 ...
 */
fun Method.getArgExceptionHandlerContext(commandSenderClass: Class<*>): VitalCommand.ArgExceptionHandlerContext {
    var commandSenderIndex: Int? = null
    var executedArgIndex: Int? = null
    var commandArgIndex: Int? = null
    ...
    for (parameter in parameters) {
        when {
            ...
            String::class.java.isAssignableFrom(parameter.type) -> executedArgIndex = parameters.indexOf(parameter)
            VitalCommand.Arg::class.java.isAssignableFrom(parameter.type) -> commandArgIndex = parameters.indexOf(parameter)
            Exception::class.java.isAssignableFrom(parameter.type) -> exceptionIndex = parameters.indexOf(parameter)
            else -> throw VitalCommandException.InvalidArgExceptionHandlerMethodSignature(this, parameter)
        }
    }

    return VitalCommand.ArgExceptionHandlerContext(this, commandSenderIndex, executedArgIndex, commandArgIndex, exceptionIndex)
}
...
fun Method.getGlobalExceptionHandlerContext(
    ...
    for (parameter in parameters) {
        when {
            ...
            VitalCommand.Arg::class.java.isAssignableFrom(parameter.type) -> commandArgIndex = parameters.indexOf(parameter)
            Array<String>::class.java.isAssignableFrom(parameter.type) -> valuesIndex = parameters.indexOf(parameter)
            Throwable::class.java.isAssignableFrom(parameter.type) -> exceptionIndex = parameters.indexOf(parameter)
 ...
 */
fun VitalCommand.GlobalExceptionHandlerContext.getInjectableGlobalExceptionHandlerMethodParameters(
    sender: Any,
    executedArg: String,
    commandArg: VitalCommand.Arg?,
    exception: Throwable,
 ...
 */
fun Class<out VitalCommand<*, *>>.getInfo(): VitalCommand.Info = getRequiredAnnotation<VitalCommand.Info>()
 ...
 * @return the VitalCommand.Info annotation of this class.
 */
fun KClass<out VitalCommand<*, *>>.getInfo(): VitalCommand.Info = java.getInfo()
 ...
 */
fun VitalCommand<*, *>.getInfo(): VitalCommand.Info = javaClass.getInfo()
 ...
 */
fun Class<*>.getAdvice(): VitalCommand.Advice = getRequiredAnnotation<VitalCommand.Advice>()
 ...
 * @return the VitalCommand.Advice annotation of this class.
 */
fun KClass<*>.getAdvice(): VitalCommand.Advice = java.getAdvice()
 ...
 */
fun Any.getVitalCommandAdvice(): VitalCommand.Advice = javaClass.getAdvice()
