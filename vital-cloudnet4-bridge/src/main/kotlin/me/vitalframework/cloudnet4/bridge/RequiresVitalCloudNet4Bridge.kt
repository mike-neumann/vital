...
/**
 * Convenience-condition to mark a class to only be loaded as a bean, when the vital-cloudnet4-bridge submodule is used.
...
class RequiresVitalCloudNet4Bridge : Condition {
    ...
    ): Boolean = ClassUtils.isPresent("me.vitalframework.cloudnet4.bridge.VitalCloudNet4BridgeSubModule", context.classLoader)
}
