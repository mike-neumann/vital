...
class VitalGradlePlugin : Plugin<Project> {
    ...
    private fun java.io.File.isVitalLoaderPackage() = path.contains("dev${File.separator}vitalframework${File.separator}loader")
    ...
    companion object {
        private const val PACKAGE_VITAL = "dev.vitalframework"
