package dev.vitalframework.loader
...
abstract class VitalClassLoader<T : Any>(
    ...
    init {
        ...
        val jarUrls =
            jarFile.entries().toList().filter { it.name.endsWith(".jar") }.map {
    ...
    class Paper(
        ...
        override fun loadClass(
            ...
            p2: Boolean,
            p3: Boolean,
        ): Class<*> = (plugin.javaClass.classLoader as PluginClassLoader).loadClass(p0, p1, p2, p3)
